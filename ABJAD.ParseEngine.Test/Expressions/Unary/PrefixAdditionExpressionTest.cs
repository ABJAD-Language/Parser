...
public class PrefixAdditionExpressionTest
{
    ...
    public void fails_to_instantiate_when_target_expression_type_is_not_number()
    {
        ...
        Assert.Throws<InvalidExpressionTypeException>(() => new PrefixAdditionExpression(expression.Object));
    }
    ...
    public void does_not_fail_to_instantiate_when_target_expression_type_is_number()
    {
        ...
        var exception = Record.Exception(() => new PrefixAdditionExpression(expression.Object));
    ...
    public void has_number_expression_type()
    {
        var expression = new Mock<Expression>();
        expression.Setup(e => e.GetDataType()).Returns(DataType.Number());
        Assert.True(new PrefixAdditionExpression(expression.Object).GetDataType().IsNumber());
    }
}
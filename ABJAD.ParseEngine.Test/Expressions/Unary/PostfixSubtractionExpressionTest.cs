...
public class PostfixSubtractionExpressionTest
{
    ...
    public void fails_to_instantiate_when_target_expression_type_is_not_number()
    {
        ...
        Assert.Throws<InvalidExpressionTypeException>(() => new PostfixSubtractionExpression(expression.Object));
    }
    ...
    public void does_not_fail_to_instantiate_when_target_expression_type_is_number()
    {
        ...
        var exception = Record.Exception(() => new PostfixSubtractionExpression(expression.Object));
    ...
    public void has_number_expression_type()
    {
        var expression = new Mock<Expression>();
        expression.Setup(e => e.GetDataType()).Returns(DataType.Number());
        Assert.True(new PostfixSubtractionExpression(expression.Object).GetDataType().IsNumber());
    }
}
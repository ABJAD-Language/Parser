...
public class LessOrEqualCheckExpressionTest
{
    ...
    public void fails_to_instantiate_if_the_operands_have_different_expression_types()
    {
        ...
        Assert.Throws<ArgumentException>(() => new LessOrEqualCheckExpression(operand1.Object, operand2.Object));
    }
    ...
    public void fails_to_instantiate_if_the_operands_were_boolean_expressions()
    {
        ...
        Assert.Throws<InvalidExpressionTypeException>(() => new LessOrEqualCheckExpression(operand1.Object, operand2.Object));
    }
    ...
    public void fails_to_instantiate_if_the_operands_were_void_expressions()
    {
        ...
        Assert.Throws<IllegalExpressionTypeException>(() => new LessOrEqualCheckExpression(operand1.Object, operand2.Object));
    }
    ...
    public void does_not_fail_to_instantiate_if_the_operands_were_number_expressions()
    {
        ...
        operand2.Setup(e => e.GetDataType()).Returns(DataType.Number());
        var expression = new LessOrEqualCheckExpression(operand1.Object, operand2.Object);
    ...
    public void has_boolean_expression_type()
    {
        ...
        operand2.Setup(e => e.GetDataType()).Returns(DataType.String());
        var expression = new LessOrEqualCheckExpression(operand1.Object, operand2.Object);
        Assert.True(expression.GetDataType().IsBool());
    }
}
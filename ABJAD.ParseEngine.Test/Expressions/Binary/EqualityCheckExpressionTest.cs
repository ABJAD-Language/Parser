...
public class EqualityCheckExpressionTest
{
    ...
    public void fails_to_instantiate_if_the_operands_are_not_of_the_same_type()
    {
        ...
        Assert.Throws<ArgumentException>(
            () => new EqualityCheckExpression(operand1.Object, operand2.Object));
    }
    ...
    public void has_bool_expression_type()
    {
        ...
        var equalityCheckExpression = new EqualityCheckExpression(operand1.Object, operand2.Object);

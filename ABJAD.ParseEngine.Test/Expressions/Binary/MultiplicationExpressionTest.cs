...
public class MultiplicationExpressionTest
{
    ...
    public void does_not_fail_to_instantiate_when_both_operands_are_numbers()
    {
        ...
        Assert.NotNull(new MultiplicationExpression(expression1.Object, expression2.Object));
    }
    ...
    public void fails_to_instantiate_when_operands_are_booleans()
    {
        ...
        Assert.Throws<InvalidExpressionTypeException>(() =>
            new MultiplicationExpression(expression1.Object, expression2.Object));
    }
    ...
    public void has_number_expression_type()
    {
        ...
        Assert.True(new MultiplicationExpression(expression1.Object, expression2.Object).GetDataType().IsNumber());
    }
}
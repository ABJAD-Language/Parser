...
public class OrOperationExpressionTest
{
    ...
    public void fails_to_instantiate_if_the_operands_are_not_of_the_same_type()
    {
        ...
        Assert.Throws<ArgumentException>(
            () => new OrOperationExpression(operand1.Object, operand2.Object));
    }
    ...
    public void does_not_fail_to_instantiate_if_the_operands_are_bool_expressions()
    {
        ...
        var operationExpression = new OrOperationExpression(operand1.Object, operand2.Object);
        Assert.NotNull(operationExpression);
    }
    ...
    public void has_bool_return_type()
    {
        ...
        operand2.Setup(o => o.GetDataType()).Returns(DataType.Bool());
        var operationExpression = new OrOperationExpression(operand1.Object, operand2.Object);
        Assert.True(operationExpression.GetDataType().IsBool());
    }
}